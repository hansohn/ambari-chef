...
if defined?(node.chef_environment)
  ...
  when 'production'
    override['hw']['ambari']['server']['config']['ambari.properties']['host_cname'] = 'ambari.prd.domain.local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.baseDn'] = 'dc=prd,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.managerDn'] = 'uid=manager,cn=users,cn=accounts,dc=prd,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.primaryUrl'] = 'ldap-server-01.prd.domain.local:636'
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_groups'] = ['prd_user_group']
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_users'] = ['prd_user']
  when 'staging'
    override['hw']['ambari']['server']['config']['ambari.properties']['host_cname'] = 'ambari.stg.domain.local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.baseDn'] = 'dc=stg,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.managerDn'] = 'uid=manager,cn=users,cn=accounts,dc=stg,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.primaryUrl'] = 'ldap-server-01.stg.domain.local:636'
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_groups'] = ['stg_user_group']
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_users'] = ['stg_user']
  else
    override['hw']['ambari']['server']['config']['ambari.properties']['host_cname'] = 'ambari.dev.domain.local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.baseDn'] = 'dc=dev,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.managerDn'] = 'uid=manager,cn=users,cn=accounts,dc=dev,dc=domain,dc=local'
    override['hw']['ambari']['server']['config']['ambari.properties']['authentication.ldap.primaryUrl'] = 'ldap-server-01.dev.domain.local:636'
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_groups'] = ['dev_user_group']
    override['hw']['ambari']['server']['setup']['ldap']['ldap_sync_users'] = ['dev_user']
  end
end
